                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">CHALLENGES</h6>
                            ...
                            <div class="card-body">
                                ...
                                if ($_SESSION["role"] == 2) {
                                    echo "<a class='btn btn-primary' href='#' data-toggle='modal' data-target='#addChallenge'>New</a><br><br>";
                                }
                                        ...
                                        echo "<li class='list-group-item'>
                                                <div class='row'>
                                                    ...
                                                    <div class='col-2'>
                                                        ...
                                                        <a class='btn btn-danger' href='../controllers/DeleteChallengeController.php?chalid={$chal->getChallengeID()}'>Delete</a>
                                                    </div>
                                                </div>
                                            </li>";
                                    }
